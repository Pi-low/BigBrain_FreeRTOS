...
extern TeUartDrv_eRetval eUartDrv_eTransmit(const uint8_t *Fpu8TxBuffer, uint16_t u16Fu16Size, uint32_t Fu32Timeout);
extern TeUartDrv_eRetval eUartDrv_eReceive(uint8_t *Fpu8RxBuffer, uint16_t *Fu16ReceiveSize, uint32_t Fu32Timeout);
extern TeUartDrv_eRetval eUartDrv_eDataAvailable(uint32_t Fu32Timeout);
